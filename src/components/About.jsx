      ...
      <div className="max-w-screen-lg mx-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="container text-xl  ">
          <p className="text-xl">
            ...
            Engineering from 2017 to 2022. During my time at NEC, I gained a
            solid foundation in various aspects of computer science and
            engineering, equipping me with the skills necessary for the field.
          </p>
          <br />
          <p className="text-xl">
          ...
          <p className="text-xl">
            ...
            Kathmandu, Nepal. This laid the groundwork for my educational
            journey and ignited my interest in pursuing a career in computer
            engineering. With my strong educational background and enthusiasm
            for technology, I am driven to contribute to the field of computer
            engineering and make a positive impact. I am constantly seeking
            opportunities to learn and grow, staying up-to-date with the latest
            advancements in the industry. My goal is to leverage my skills and
            knowledge to solve complex problems and create innovative solutions
